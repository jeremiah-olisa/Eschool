...
class QuizMarkerMixin(object):
    ...
    def get_context_data(self, **kwargs):
        ...
        context = super(QuizMarkerMixin, self)\
            .get_context_data(**kwargs)
        context['profileData'] = profileData
        context['title'] = 'Test Marker'
        return context
...
class SittingFilterTitleMixin(object):
    ...
    def get_context_data(self, **kwargs):
        try:
            ...
            profileData = []
            messages.info(request, "Please Create a Profile")
        context = super(SittingFilterTitleMixin, self)\
            .get_context_data(**kwargs)
        context['profileData'] = profileData
        context['title'] = 'Sitting Filter'
        return context
...
class QuizUserProgressView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['profileData'] = profileData
        context['title'] = f'{self.request.user} Progress'
        return context
...
class QuizMarkingList(QuizMarkerMixin, SittingFilterTitleMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context = super(QuizMarkingList, self)\
            .get_context_data(**kwargs)

        context['profileData'] = profileData
        context['title'] = 'Quiz Marking List'
        return context
...
class QuizMarkingDetail(QuizMarkerMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['profileData'] = profileData
        context['title'] = 'Quiz Marking Detail'
        context['questions'] =\
